...
export function IOSDevice({ children, width = 402, height = 874 }: IOSDeviceProps) {
  return (
    <div style={{ width, height, borderRadius:48, overflow:'hidden', position:'relative', background:'#F2F2F7', boxShadow:'0 40px 80px rgba(0,0,0,.18), 0 0 0 1px rgba(0,0,0,.12)', fontFamily:'-apple-system,system-ui,sans-serif', WebkitFontSmoothing:'antialiased' }}>
      {/* Dynamic island */}
