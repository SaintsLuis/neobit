...
export function HomeScreen({ user, onPay, onNav, onInvoice, onSpeak }: HomeScreenProps) {
  ...
  return (
    <div className="lumi-page" style={{ padding:'70px 20px 28px' }}>
      ...
      {/* Accesos rápidos */}
      <div className="lumi-eyebrow" style={{ marginTop:28, marginBottom:12 }}>Acceso rápido</div>
      ...
      {/* Estado del servicio */}
      <div className="lumi-eyebrow" style={{ marginTop:28, marginBottom:12 }}>Su servicio</div>
