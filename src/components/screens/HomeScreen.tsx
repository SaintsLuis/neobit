...
export function HomeScreen({
  ...
  const invoiceCard = (
    <div
      style={{
        ...
        color: '#fff',
        boxShadow: '0 14px 36px rgba(226,89,5,.32)',
        position: 'relative',
        overflow: 'hidden',
      }}
    >
      ...
      {/* Botón Pagar Ahora (Movido hacia arriba) */}
      <button
        onClick={onPay}
        style={{
          width: '100%',
      ...
      {/* Fechas de corte y vencimiento (Movidas hacia abajo) */}
      <div
        style={{
          paddingTop: 16,
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        <div className='lumi-list-row'>
          <div
            ...
            style={{ background: 'var(--ok-50)' }}
          >
            <Icon name='checkCircle' size={26} color='var(--ok-500)' />
          </div>
          <div style={{ flex: 1 }}>
            <div className='lumi-body-strong'>Servicio activo</div>
            <div className='lumi-small'>Sin interrupciones reportadas</div>
          </div>
        </div>
        <div className='lumi-list-row'>
          <div
          ...
          >
            <Icon name='trendUp' size={26} color='var(--info-500)' />
          </div>
          <div style={{ flex: 1 }}>
            <div className='lumi-body-strong'>245 kWh este mes</div>
            <div className='lumi-small'>12 kWh menos que abril</div>
          </div>
        </div>
        <div className='lumi-list-row'>
          <div
          ...
          >
            <Icon name='calendar' size={26} color='var(--o-600)' />
          </div>
          <div style={{ flex: 1 }}>
            <div className='lumi-body-strong'>Último pago</div>
            <div className='lumi-small'>$118.200 · 15 abril 2026</div>
          </div>
          <div
            style={{
  ...
  return (
    <div className='lumi-page' style={{ padding: '60px 20px 28px' }}>
      ...
      >
        <div>
          <div className='lumi-small' style={{ marginBottom: 4 }}>
            {greeting},
          </div>
          <div className='lumi-h1' style={{ fontSize: 32 }}>
            {user.name}
          </div>
        </div>
        <button
      ...
      <div style={{ marginTop: 28 }}>{quickAccess}</div>
